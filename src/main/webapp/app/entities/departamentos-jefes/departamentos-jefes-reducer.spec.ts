...
import reducer, {
  ...
  reset,
  updateEntity,
} from './departamentos-jefes.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEPARTAMENTOSJEFES_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DEPARTAMENTOSJEFES actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DEPARTAMENTOSJEFES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DEPARTAMENTOSJEFES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DEPARTAMENTOSJEFES actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DEPARTAMENTOSJEFES actions', async () => {
      const arg = 42666;
