...
import reducer, {
  ...
  reset,
  updateEntity,
} from './informacion-contacto-jefe.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INFORMACIONCONTACTOJEFE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INFORMACIONCONTACTOJEFE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INFORMACIONCONTACTOJEFE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_INFORMACIONCONTACTOJEFE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_INFORMACIONCONTACTOJEFE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INFORMACIONCONTACTOJEFE actions', async () => {
      const arg = 42666;
