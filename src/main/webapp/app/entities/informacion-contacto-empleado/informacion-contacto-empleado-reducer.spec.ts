...
import reducer, {
  ...
  reset,
  updateEntity,
} from './informacion-contacto-empleado.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INFORMACIONCONTACTOEMPLEADO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INFORMACIONCONTACTOEMPLEADO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INFORMACIONCONTACTOEMPLEADO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_INFORMACIONCONTACTOEMPLEADO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_INFORMACIONCONTACTOEMPLEADO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INFORMACIONCONTACTOEMPLEADO actions', async () => {
      const arg = 42666;
