...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRESUPUESTO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRESUPUESTO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRESUPUESTO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PRESUPUESTO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PRESUPUESTO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PRESUPUESTO actions', async () => {
      const arg = 42666;
