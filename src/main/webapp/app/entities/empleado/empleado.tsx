  ...
  return (
    <div>
      <h2 id="empleado-heading" data-cy="EmpleadoHeading">
        <Translate contentKey="dundermifflinApp.empleado.home.title">Empleados</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="dundermifflinApp.empleado.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/empleado/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="dundermifflinApp.empleado.home.createLabel">Create new Empleado</Translate>
          </Link>
        </div>
      </h2>
        ...
        {empleadoList && empleadoList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="dundermifflinApp.empleado.id">ID</Translate>{' '}
                ...
                <th className="hand" onClick={sort('nombreEmpleado')}>
                  ...
                  <FontAwesomeIcon icon={getSortIconByFieldName('nombreEmpleado')} />
                </th>
                <th className="hand" onClick={sort('apellidoEmpleado')}>
                  <Translate contentKey="dundermifflinApp.empleado.apellidoEmpleado">Apellido Empleado</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('apellidoEmpleado')} />
                </th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="dundermifflinApp.empleado.home.notFound">No Empleados found</Translate>
            </div>
          )
        )}
      </div>
