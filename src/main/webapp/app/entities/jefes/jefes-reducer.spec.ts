...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './jefes.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_JEFES_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_JEFES actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_JEFES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_JEFES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_JEFES actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_JEFES actions', async () => {
      const arg = 42666;
