...
import reducer, {
  ...
  reset,
  updateEntity,
} from './informacion-contacto-empleados.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INFORMACIONCONTACTOEMPLEADOS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INFORMACIONCONTACTOEMPLEADOS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INFORMACIONCONTACTOEMPLEADOS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_INFORMACIONCONTACTOEMPLEADOS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_INFORMACIONCONTACTOEMPLEADOS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INFORMACIONCONTACTOEMPLEADOS actions', async () => {
      const arg = 42666;
