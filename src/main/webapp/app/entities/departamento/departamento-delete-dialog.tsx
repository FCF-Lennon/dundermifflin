...
export const DepartamentoDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="dundermifflinApp.departamento.delete.question">
        <Translate contentKey="dundermifflinApp.departamento.delete.question" interpolate={{ id: departamentoEntity.id }}>
