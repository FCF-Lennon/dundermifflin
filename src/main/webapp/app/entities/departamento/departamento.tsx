  ...
  return (
    <div>
      <h2 id="departamento-heading" data-cy="DepartamentoHeading">
        <Translate contentKey="dundermifflinApp.departamento.home.title">Departamentos</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="dundermifflinApp.departamento.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/departamento/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="dundermifflinApp.departamento.home.createLabel">Create new Departamento</Translate>
          </Link>
        </div>
      </h2>
        ...
        {departamentoList && departamentoList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="dundermifflinApp.departamento.id">ID</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('nombreDepartamento')}>
                  <Translate contentKey="dundermifflinApp.departamento.nombreDepartamento">Nombre Departamento</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('nombreDepartamento')} />
                </th>
                <th className="hand" onClick={sort('ubicacionDepartamento')}>
                  <Translate contentKey="dundermifflinApp.departamento.ubicacionDepartamento">Ubicacion Departamento</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('ubicacionDepartamento')} />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="dundermifflinApp.departamento.home.notFound">No Departamentos found</Translate>
            </div>
          )
        )}
      </div>
