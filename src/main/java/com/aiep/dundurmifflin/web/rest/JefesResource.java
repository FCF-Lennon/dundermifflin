...
import com.aiep.dundurmifflin.repository.JefesRepository;
import com.aiep.dundurmifflin.service.JefesService;
...
/**
 * REST controller for managing {@link com.aiep.dundurmifflin.domain.Jefes}.
 */
@RestController
...
public class JefesResource {
     ...
     */
    @PostMapping("")
    public ResponseEntity<JefesDTO> createJefes(@Valid @RequestBody JefesDTO jefesDTO) throws URISyntaxException {
    ...
    public ResponseEntity<JefesDTO> updateJefes(
        ...
        @Valid @RequestBody JefesDTO jefesDTO
    ...
    public ResponseEntity<JefesDTO> partialUpdateJefes(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody JefesDTO jefesDTO
    ) throws URISyntaxException {
