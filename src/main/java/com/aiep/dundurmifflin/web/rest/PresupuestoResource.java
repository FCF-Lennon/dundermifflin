...
import com.aiep.dundurmifflin.service.PresupuestoService;
...
/**
 * REST controller for managing {@link com.aiep.dundurmifflin.domain.Presupuesto}.
 */
@RestController
...
public class PresupuestoResource {
    ...
    public ResponseEntity<PresupuestoDTO> partialUpdatePresupuesto(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody PresupuestoDTO presupuestoDTO
    ) throws URISyntaxException {
