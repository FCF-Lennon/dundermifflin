...
import com.aiep.dundurmifflin.repository.InformacionContactoEmpleadoRepository;
import com.aiep.dundurmifflin.service.InformacionContactoEmpleadoService;
...
/**
 * REST controller for managing {@link com.aiep.dundurmifflin.domain.InformacionContactoEmpleado}.
 */
@RestController
...
public class InformacionContactoEmpleadoResource {
    ...
    public ResponseEntity<InformacionContactoEmpleadoDTO> createInformacionContactoEmpleado(
        @Valid @RequestBody InformacionContactoEmpleadoDTO informacionContactoEmpleadoDTO
    ...
    public ResponseEntity<InformacionContactoEmpleadoDTO> partialUpdateInformacionContactoEmpleado(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody InformacionContactoEmpleadoDTO informacionContactoEmpleadoDTO
    ) throws URISyntaxException {
