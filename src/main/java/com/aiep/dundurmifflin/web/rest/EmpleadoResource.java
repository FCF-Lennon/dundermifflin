...
/**
 * REST controller for managing {@link com.aiep.dundurmifflin.domain.Empleado}.
 */
@RestController
...
public class EmpleadoResource {
    ...
    public ResponseEntity<List<EmpleadoDTO>> getAllEmpleados(
        ...
        Page<EmpleadoDTO> page;
        if (eagerload) {
            page = empleadoService.findAllWithEagerRelationships(pageable);
        } else {
            page = empleadoService.findAll(pageable);
        }
