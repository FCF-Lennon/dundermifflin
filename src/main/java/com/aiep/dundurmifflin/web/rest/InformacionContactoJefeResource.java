...
import com.aiep.dundurmifflin.repository.InformacionContactoJefeRepository;
import com.aiep.dundurmifflin.service.InformacionContactoJefeService;
...
/**
 * REST controller for managing {@link com.aiep.dundurmifflin.domain.InformacionContactoJefe}.
 */
@RestController
...
public class InformacionContactoJefeResource {
    ...
    public ResponseEntity<InformacionContactoJefeDTO> createInformacionContactoJefe(
        @Valid @RequestBody InformacionContactoJefeDTO informacionContactoJefeDTO
    ...
    public ResponseEntity<InformacionContactoJefeDTO> partialUpdateInformacionContactoJefe(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody InformacionContactoJefeDTO informacionContactoJefeDTO
    ) throws URISyntaxException {
