...
import com.aiep.dundurmifflin.service.mapper.InformacionContactoJefeMapper;
...
class InformacionContactoJefeResourceIT {
    ...
    void checkTelefonoIsRequired() throws Exception {
        ...
        // set the field null
        informacionContactoJefe.setTelefono(null);

        // Create the InformacionContactoJefe, which fails.
        InformacionContactoJefeDTO informacionContactoJefeDTO = informacionContactoJefeMapper.toDto(informacionContactoJefe);
    ...
    @Test
    @Transactional
    void checkTipoFonoIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        informacionContactoJefe.setTipoFono(null);
