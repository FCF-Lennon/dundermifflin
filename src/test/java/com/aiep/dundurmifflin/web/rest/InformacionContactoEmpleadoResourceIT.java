...
import com.aiep.dundurmifflin.service.mapper.InformacionContactoEmpleadoMapper;
...
class InformacionContactoEmpleadoResourceIT {
    ...
    void checkTelefonoIsRequired() throws Exception {
        ...
        // set the field null
        informacionContactoEmpleado.setTelefono(null);

        // Create the InformacionContactoEmpleado, which fails.
        InformacionContactoEmpleadoDTO informacionContactoEmpleadoDTO = informacionContactoEmpleadoMapper.toDto(
            informacionContactoEmpleado
        );
