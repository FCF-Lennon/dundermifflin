...
import com.aiep.dundurmifflin.repository.DepartamentoRepository;
import com.aiep.dundurmifflin.service.dto.DepartamentoDTO;
import com.aiep.dundurmifflin.service.mapper.DepartamentoMapper;
...
class DepartamentoResourceIT {
    ...
    @Test
    @Transactional
    void checkUbicacionDepartamentoIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        departamento.setUbicacionDepartamento(null);
