...
import static com.aiep.dundurmifflin.web.rest.TestUtil.sameNumber;
...
import com.aiep.dundurmifflin.repository.PresupuestoRepository;
import com.aiep.dundurmifflin.service.dto.PresupuestoDTO;
import com.aiep.dundurmifflin.service.mapper.PresupuestoMapper;
...
class PresupuestoResourceIT {
    ...
    @Test
    @Transactional
    void checkPresupuestoDepartamentoIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        presupuesto.setPresupuestoDepartamento(null);
